...
void HardwareSetup(void)
{
	...
	MSTP.CRA.BYTE = 0xff; 	// Disable DMA & DTC                         
  	...
  	MSTP.CRC.BIT.B7 = 0;  	// SCI3 used by IMC -- IOC        MSTPCRC
  	MSTP.CRC.BIT.B6 = 0;  	// SCI4 used by IOC -- IOC
	...
	// TimeProvider 5000. Actually A21 won't work without Cs5 for flash
	// 1/7/2008 Bob will disconnect A21 on flash.
	BSC.PFCR.BYTE = 0x2d;  // Use address up tp A20. Set Buzz output because it's not connected. 

#if 0
#if RAM_2M_BYTE    	
	BSC.PFCR.BYTE = 0x0d;	// A8 --A19 & A20 used. A21 to A23 disabled.
#else
	BSC.PFCR.BYTE = 0x0C;  	// A8 - A19 used, A20-A23 disabled.
#endif
#endif
	...
	BSC.ASTCR.BIT.B3 = 0;  // 0: 2-state access to LED.
	...
	P7.DDR = 0x81;    		// IMC_RX=Input, BP id0 -- 3 input
							// CS4, IMC_TX = Output
...
#if 0
  	TMR0.TCR.BIT.CMIEA = 0; /*ZM: Disable enable interrupt for A */
  	TMR0.TCR.BIT.CCLR = 1; 	/* cleared by Match of A */ 
  	TMR0.TCR.BIT.CKS = 3; 	/* 1/8192 of system clock (18MHz/8192 = .45 msec) */ 
  	TMR0.TCORA = INTR_RATE; /* set to max 255 * .45 ms = 114 ms*/ 
#endif
    ...
    // Interrupt priority
  	...
  	INTC.IPRB.BIT.LOW  = 0;  // Set IRQ4,IRQ5 -  25ms
  	INTC.IPRC.BIT.HIGH = 0;  // Set IRQ6,IRQ7 -  250 ms
