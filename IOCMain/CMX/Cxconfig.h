...
*********************************************************************/  
/*
 * $Header: Cxconfig.h 1.1 2007/12/06 11:41:08PST Zheng Miao (zmiao) Exp  $
 * $Revision: 1.1 $
 */
...
#pragma pack 2
#define C_MAX_TASKS 20	/* Maximum number of tasks for this program. */
#define C_MAX_RESOURCES 20	/* Maximum number of resources. */
#define C_MAX_CYCLIC_TIMERS 5	/* Maximum number of cyclic timers. */
#define C_MAX_MESSAGES 300	/* Maximum number of messages. */
#define C_MAX_QUEUES 20	/* Maximum number of queues. */
#define C_MAX_MAILBOXES 10	/* Maximum number of mailboxes. */
#define C_MAX_SEMAPHORES 6	/* Maximum number of mailboxes. */
