 ...
 * All rights reserved. 
 * RCS: $Header: BTMONDL.h 1.1 2007/12/06 11:38:51PST Zheng Miao (zmiao) Exp  $
 */             
...
class CBtmonDL {
public:
	void Start(Ccomm *pWork, Ccomm *pDebug, CFlash *pFlash, unsigned long initAddress = 0x810000);
	CBtmonDL(void);
	~CBtmonDL();
private:
